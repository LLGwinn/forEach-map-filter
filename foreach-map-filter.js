...
function addKeyAndValue(arr,key,value){
    return arr.map(function(elem, ind, arr) {
        elem[key] = value;
        return elem;
    })
...
function vowelCount(str){
    ...
    const newArray = strArray.filter(function(elem) {
        return vowels.includes(elem);
    });
    const result = {};
    newArray.forEach(function(val, ind, arr) {
...
function valTimesIndex(arr){
    ...
    return arr.map(function(val, ind, arr) {
        return val * ind;
    })
}
...
function filterByValue(arr, key) {
    return arr.filter(function(val, ind, arr) {
...
function findInObj(arr, key, searchValue) {
    ...
    return arr.filter(function(obj, ind, arr) {
